---
title: "Polyscript documentation home"
description: "Start here to set up your docs site, customize the theme, write pages with MDX, build API references, and make content agent-ready for AI tools."
icon: 'star'
---
