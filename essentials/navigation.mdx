---
title: 'Navigation'
description: 'Configure the navigation field in docs.json to organize pages into nested groups, sections, and tabs that appear in your Mintlify sidebar menu.'
icon: 'map'
---
