...
description: "Create reusable MDX snippets in the snippets directory and import them across pages to keep recurring content in sync without duplicating files."
icon: "recycle"
---
