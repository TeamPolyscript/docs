---
title: 'Configuration'
description: 'Configure your Mintlify site name, theme colors, logo, favicon, navigation, social links, and SEO defaults using the docs.json configuration file.'
icon: 'gear'
---
