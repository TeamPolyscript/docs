...
description: 'Install the Mintlify CLI to preview Polyscript documentation locally, edit MDX files, and see live updates before pushing changes to production.'
icon: 'terminal'
---
