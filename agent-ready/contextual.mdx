...
description: 'Configure the Mintlify contextual toolbar so readers can copy page content, open it in Claude or ChatGPT, or install your docs as an MCP server.'
icon: 'bolt'
---
