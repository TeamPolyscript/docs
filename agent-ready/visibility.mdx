---
title: 'Visibility'
description: 'Use the Mintlify Visibility component to serve different content to humans and AI agents from one MDX page, with rendered and Markdown variants.'
icon: 'eye'
---
