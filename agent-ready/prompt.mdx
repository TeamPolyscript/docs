...
description: 'Use the Mintlify Prompt component to embed ready-to-use AI prompts in your docs that readers can copy to the clipboard or open directly in Cursor.'
icon: 'robot'
---
